...
public class PhraseOMatic {
    public static void main(String[] args) {
        ...
        String[] wordListTwo = {"loosely coupled","opinionated","voice activated","event driven",
        "pub-sub","IoT","cloud native","service oriented","contanerised","serverless","microservices",
        "distributed ledger"};
